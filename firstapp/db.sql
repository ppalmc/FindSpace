...
SELECT R1.workspaceid, R2.workspaceid, R2.ws_lat, R2.ws_long, R1.ppl_in_WS, R2.totalseat, R1.ppl_in_WS/R2.totalseat AS crowdedness, R3.photo1, R3.photo2, R3.photo3,
...
WHERE R1.workspaceid = R2.workspaceid AND R1.workspaceid = R3.workspaceid 
